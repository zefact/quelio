 ...
 * ヘルプ: 照合順序。
 *
 * 「同じとみなす」の話は MySQL と PostgreSQL で前提から違うので、
 * DBの種類を受け取って中身を組み替える
 */
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["_ai", "濁点やアクセントを区別しない (accent insensitive)"],
        ["_as", "濁点やアクセントを区別する"],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        [
          "utf8mb4_0900_ai_ci",
          "MySQL 8 の既定。大小もアクセントも区別せず、速い",
        ],
        ["utf8mb4_ja_0900_as_cs", "日本語向け。濁点も大小も区別する"],
        [
          "utf8mb4_bin",
          "打ったとおりに一致させたいとき (ID・コード・パスワードのハッシュなど)",
        ],
        [
          "utf8mb4_general_ci",
          "MariaDB や MySQL 5.7 でよく使われる。英字の大小だけを同じとみなす",
        ],
        [
          "utf8mb4_unicode_ci",
          "こちらも 5.7 系でよく使われる。Unicode の規則で、濁点や全角半角まで同じとみなす",
        ],
      ],
    },
  },
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        [
          "C / POSIX",
          "文字の番号順で並べる。速く、どの環境でも同じ結果になる。日本語は辞書順にはならない",
        ],
        ["C.utf8", "C とほぼ同じ (文字の扱いだけ UTF-8)"],
        ["ja_JP.utf8", "日本語の辞書順。OSに入っている場合だけ選べる"],
      ],
    },
  },
  {
...
export const COLLATION: HelpTopic = {
  id: "collation",
  label: "照合順序",
  note: "並び順と、同じとみなす文字",
